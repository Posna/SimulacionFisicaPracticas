...
ParticleSystemRigid* partSystem;
...
void initPhysics(bool interactive)
{
	...
	t = new PxTransform(Vector3(0.0, -50.0, 0.0));
	...
	//RenderItem aux = RenderItem(pShape, particleRigid,Vector4(1.0, 0.0, 0.0, 1.0));

	partSystem = new ParticleSystemRigid(gPhysics, gScene);
}
